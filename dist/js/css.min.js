...
function buttons_list() {
    var buttons_list = document.querySelector('.buttons_list');
    var buttons = document.querySelectorAll('.buttons_list .btn');
...
//animatedForms
function form() {
    var modal_boxs = document.querySelector('.modal-bodies');
    var button_next = document.querySelector('.text-center .button');
    var next_modal_body_step = 1;
    ...
    var btn = document.querySelector('.modal-bodies');

    btn.addEventListener('click', function (e) {
        var x = e.target.offsetParent.classList[1];
        var number = x[x.length - 1];
        var current = document.querySelector('.modal-body-step-' + number);
        modal_header[number - 1].classList.remove('is-active');
        current.classList.remove('is-showing');
        number++;

        if (number < 4) {
            var next = document.querySelector('.modal-body-step-' + number);
...
var parallax = {
    ...
    startHeroes: function startHeroes() {
        var parallax_background = document.querySelector('.parallax__background');
    ...
    stopHeroes: function stopHeroes() {
...
function showCustomPropertyCss() {
    var lukiExample = document.querySelector('.customPropertyCsss__text');

    var result1 = window.getComputedStyle(lukiExample).getPropertyValue('font-size');
    console.log("window.getComputedStyle(lukiExample).getPropertyValue('font-size'):    ", result1);

    var result2 = lukiExample.computedStyleMap().get('font-size');
