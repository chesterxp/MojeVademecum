...
var hitTheMole = {
    ...
    addTurnOffGOEvent: function addTurnOffGOEvent() {
    ...
    addActiveEvent: function addActiveEvent() {
    ...
    changeLevel: function changeLevel(lvl) {
        switch (lvl) {
            case 'easy':
    ...
    removeActive: function removeActive(btns) {
        btns.forEach(function (btn) {
    ...
    showMole: function showMole() {
        var time = this.randomTime(hitTheMole.activeLvl.min, hitTheMole.activeLvl.max);
    ...
    //reset czasu 
    restartTime: function restartTime() {
    ...
    addingPlayerData: function addingPlayerData() {
        var player = {};
    ...
    addingRankingToLocalStorage: function addingRankingToLocalStorage() {
        window.localStorage.setItem('HitTheMole', JSON.stringify(hitTheMole.users));
    },
    //utworzenie bazy użytkowników z localstorage
    makeObjectFromLocalStorage: function makeObjectFromLocalStorage() {
