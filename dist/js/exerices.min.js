...
function exericesWithCss() {
    var first = document.querySelector('#dodajKlase');
...
function funWithPhoto() {
    var img = document.querySelector('.tomato');
...
function showWindow() {
    var show = document.querySelector('.showWindow');
...
function whenMyBirthday() {
    ...
    var destinationDate = new Date(year, month - 1, day, hour, minute);

    var diffrent = destinationDate - currentDate;
    ...
    if (diffrent < 0) {
        ...
        var day2 = Math.floor(diffrent / dayInMS); //3

        var restOfhour = diffrent % dayInMS;
        var hour2 = Math.floor(restOfhour / hourInMS);

        var restOfMinutes = diffrent % hourInMS;
        var minute2 = Math.floor(restOfMinutes / minuteInMS);

        var restOfsecond = diffrent % minuteInMS;
        var second2 = Math.floor(restOfsecond / secontInMs);
        console.log(second2);
...
function GetSum(a, b) {
    ...
    if (a == b) return a;else {
        var newArr = [].concat(Array.prototype.slice.call(arguments));
        ...
        console.log('arr', arr);
        var t = arr.reduce(function (total, el) {
...
var c1 = [1, 2, 4, 6, 7, 3, 2, 4, 1];
console.log(Math.max.apply(Math, c1));
var a1 = 3.12;
var a2 = 4.13;

console.log(Math.min.apply(Math, c1));
var c2 = 'house';
var c2b = 'I love javascript';
// console.log(c2.charAt(0).toLocaleLowerCase());
var c3 = c2[0].toUpperCase() + c2.substr(1);
console.log(c3);
var c4 = c2.indexOf('o');
console.log(c4);
...
var c5 = c2.length > 10 ? 'długi wyraz' : 'short word';
console.log(c5);
...
function superSum() {
    if (arguments.length <= 4) {
        ...
        var result = arr.reduce(function (result, el) {
            return result += el;
        }, 0);
        console.log(result);
    }
...
var scop1 = scope.querySelectorAll('.scop');
...
function setCookie(name, val, days, path, domain, secure) {
    if (navigator.cookieEnabled) {
        ...
        if (typeof days === "number") {
            var _data = new Date();
            _data.setTime(_data.getTime() + days * 24 * 60 * 60 * 1000);
            cookieText += "; expires=" + _data.toGMTString();
        }
